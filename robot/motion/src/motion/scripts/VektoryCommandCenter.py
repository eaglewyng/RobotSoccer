...
class Field(Frame):
    ...
    def key(self,event):
        ...
        if keyPressed == 'g': # Run the "Play" strategy
          self.sendCommandCenter((2, 0, 0))
        elif keyPressed == 's': # Stop
          self.sendCommandCenter((1, 0, 0))
        elif keyPressed == 'c': # Go To Center
          self.sendCommandCenter((3, 0, 0))
    ...
    def callback(self,event):
        ...
        self.sendCommandCenter((6, event.x - WIDTH_FIELD/2 - GUI_MARGIN, -(event.y - HEIGHT_FIELD/2 - GUI_MARGIN)))
